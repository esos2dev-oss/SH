-- =============================================================================
-- Fix: ORDER BY dentro de jsonb_agg debe ser parte de la funcion agregada,
-- no un ORDER BY de la subquery. La sintaxis correcta es:
--     jsonb_agg(expr ORDER BY col)
-- =============================================================================
